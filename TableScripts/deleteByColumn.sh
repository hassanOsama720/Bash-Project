...
do
    case $option in
        "Delete Another Column") ./TableScripts/deleteByColumn.sh;;
        "Return To The Delete Menu") ./TableScripts/delete.sh;;
        "Return To The Table Menu") ./TableScripts/tableMenu.sh;;
